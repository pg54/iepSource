    ...
    <div class="tabs">
        <div class="mainContentWrap">
            <div v-if="isIEP" class="pageNavbar">
                ...
                <span v-show="showPlanDetailsFlag || showPlanItemContentFlag  || showMouthContentFlag  || showWeekContentFlag || showTrianingPaperFlag" @click="getPlanDetails(navPlanID)">计划详情&nbsp;&nbsp;>&nbsp;&nbsp;</span>
                <span v-show="showPlanItemContentFlag  || showMouthContentFlag  || showWeekContentFlag || showTrianingPaperFlag ">{{ planAcitonNname }}&nbsp;&nbsp;>&nbsp;&nbsp;</span>
            </div>
            ...
            <div v-if="!isIEP" class="pageNavbar">
                ...
                <span v-show="showPlanDetailsFlag || showPlanItemContentFlag  || showMouthContentFlag  || showWeekContentFlag" @click="getPlanDetails(navPlanID)">计划详情&nbsp;&nbsp;>&nbsp;&nbsp;</span>
                <span v-show="showPlanItemContentFlag  || showMouthContentFlag  || showWeekContentFlag ">{{ planAcitonNname }}&nbsp;&nbsp;>&nbsp;&nbsp;</span>
            </div>
            <div class="severalBoxes">
                                ...
                                <div class="toolBox">
                                    <el-row v-if="isIEP" type="flex" justify="space-between">
                                        <el-col :span="10">
                                            <el-row :gutter="10">
                                                <el-col :span="16">
                                                    <input class="onc-input" v-model="filttUser" placeholder="输入患者名称、计划名称查询" @keyup.13="getUserName">
                                                </el-col>
                                                <el-col :span="8">
                                        ...
                                        <div class="tableWrap">
                                            <el-table :data="personalPlanData.Records" style="width: 100% ">
                                                ...
                                                <el-table-column label="操作" width="300" align="center">
                                                    <template scope="scope">
                                                        <el-button size="small" :plain="true" type="warning" @click="goPlanDetails(scope.row)">计划详情</el-button>
                ...
                <!--月计划编辑页-->
                <div class="course-content" v-show="showMouthContentFlag">
                    <div class="grayBackground">
                        <div class="iepmultiChose">
                                        ...
                                        <div class="chaptesBox">
                                            <div v-for="chapt in course.Child">
                                                ...
                                                <div class="checkBoxItems">
                                                    ...
                                                    <div class="chaptName">
                                                        <span class="chaptName-course">{{ chapt.Name }}</span>
                                                        <!-- <span>{{ chapt.LatestResult}}</span> -->
                                                        <span v-for="ele in chapt.History" style="margin-right: 6px">
                                                            {{ ele.Result }}:{{ ele.Count }}
                                                        </span>
                                                    </div>
                                                    <div class="mouthItem">
                            ...
                            <div class="submitBox" v-bind:class="{narrowSubmitBox : narrow}">
                                <el-button type="primary" @click="submitMouthData" class="submitBtn">提交课程</el-button>
                            </div>
                ...
                <div class="course-content" v-show="showWeekContentFlag">
                    <div class="grayBackground">
                        <div class="iepmultiChose">
                            ...
                            <div class="submitBox" v-bind:class="{narrowSubmitBox : narrow}">
                                <el-button type="primary" @click="submitWeekData" class="submitBtn">提交课程</el-button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="course-content" v-show="showTrianingPaperFlag">
                    <div style="width: 800px;margin: 0 auto;height: 540px;overflow-y:scroll">
                        <div v-show="currentTab === 0">
                            <iepPrinterJT :paperData="JTtrainingPaperData" :paperTitle="JTtrainingPaperTitle" :verticalTitle="JTiepTotalTheme"></iepPrinterJT>
                        </div>
                        <div v-show="currentTab === 1">
                            <iepPrinter :iepMothInfo="trainingPaperData" :iepTitle="trainingPaperTitle" :iepTheme="iepTotalTheme"></iepPrinter>
                        </div>
                    </div>
                </div>
            ...
            <el-form ref="form" :model="planFormData" label-width="100px">
                    ...
                    <el-row :gutter="24">
                        <el-col :span="12">
                            <el-form-item label="患者组:">
                                <el-select style="width: 100%" v-model="planFormData.GroupID" placeholder="请选择小组" @change="groupChange">
                ...
                <div v-show="isPeronalPlanFlag">
                    <el-row :gutter="24">
                        ...
                        <el-col :span="12">
                            <el-form-item label="">
                                <el-select style="width: 80%" v-model="planFormData.StudentID" placeholder="请选择患者" @change='changePacientAgentID'>
                ...
                <template v-if="isPeronalPlanFlag">
                    <el-row :gutter="24" v-if="planFormData.StudentID">
                        <el-col :span="23">

                            <el-form-item label="">
                                <el-alert v-if='!showPackageMsg' title="请先安排评测" type="info" :closable="false" show-icon>
                                </el-alert>
                            </el-form-item>

                            <el-form-item v-if='showPackageMsg' label="评测表">

                                <el-select v-model="planFormData.PaperPackageID" placeholder="请选择评测表" style="width:100%">
                                    <el-option v-for="o in testedPakegeNames" :label="o.Name" :value="o.ID"></el-option>
                                </el-select>
                ...
                <template v-else>
                    ...
                    <el-row :gutter="24" v-show="addCoursePackage">
                        <el-col :span="23">
                            <el-form-item label="">
                                <div class="checkBoxWrap">
                                    <el-row :gutter="10">
                                        <el-col :span="16">
                                            <input class="onc-input" style="margin-left: 15px" placeholder="请输入课程包名" v-model="planFormData.newPackageName">
                                        </el-col>
                                        <el-col :span="8">
...
<script>
    ...
    import iepPrinter from './printerIEP.vue'
    import iepPrinterJT from './jtIEPPrint.vue'
    ...
    export default {
        ...
        data() {
            return {
                ...
                testedPakegeNames: '',
                showPackageMsg: false,
                addCoursePackage: false,
                trainingPaperData: [],
                trainingPaperTitle: '',
                iepTotalTheme: '',
                JTtrainingPaperData: [],
                JTtrainingPaperTitle: '',
                JTiepTotalTheme: '',
            }
        },
        computed: {
            ...
            selectID: function () {
                return this.planFormData.StudentID
            }
        },
        watch: {
            selectID: function () {
                if (!this.isPeronalPlanFlag) return
                if (this.selectID && this.selectID !== '') { //默认值和没有选中时不触发
                    let _this = this
                    let id = _this.selectID
                    api.requestPatientTest(id).then(res => {
                        let arr = []
                        for (let ele of res.List) {
                            for (let el of _this.packageData) {
                                if (el.ID === ele.PaperPackageID) {
                                    let obj = {
                                        ID: el.ID,
                                        Name: el.Name
                                    }
                        ...
                        if (arr.length === 0) {
                            this.showPackageMsg = false
                        } else {
                            // _this.testedPakegeNames = '学生已评测的课程包：' + arr.join('\n')
                            _this.testedPakegeNames = arr
                            _this.showPackageMsg = true
                        }
        ...
        methods: {
            ...
            changePacientAgentID() {
                this.planFormData.PaperPackageID = '';
            },
            createNewPakage() {
                let CourseIDs = this.planFormData.Courses.map(function (ele) {
                    let obj = {
                        ID: ele
                    }
                    return obj
                })
                let name = this.planFormData.newPackageName
            ...
            gobackPlanList() {
                ...
                this.showMouthContentFlag = false;
                this.showWeekContentFlag = false;
                this.showTrianingPaperFlag = false;
            },
            //切换选项卡
            ...
            goPlanDetails(row) {
                let id = row.ID
                let pID = row.StudentID
                this.getPlanDetails(id)
                //如果是集体计划就不用更新当前选中的患者信息。
                if(this.currentTab === 0) return
                api.getPatientAgentDetails(pID)
                    .then((res) => {
                        let o = res.data;
            ...
            requestPlanItemDetails(item, title) {
                let self = this
                api.getPlanItemDetail(item.ID).then(res => {
                    self.requestItemDetails(item.ID);
                    self.showPlanDetailsFlag = false;
                    self.showTabsContentFlag = false;
                    self.showPlanItemContentFlag = true;
                    self.planAcitonNname = title;
                    self.currentPlanLine = item;
                })
            },
            //编辑周计划
            editWeekPlan(item) {
            ...
            traningPaper(item, title, verticalTitle) {
                api.getPlanItemDetail(item.ID).then(res => {
                    if (this.currentTab === 0) {
                        this.JTtrainingPaperData = res.List;
                        this.JTtrainingPaperTitle = '智力残疾康复个别化教育计划（IEP）' + '-' + title + '训练表';
                        this.JTiepTotalTheme = verticalTitle;
                    } else {
                        this.trainingPaperData = res.List;
                        this.trainingPaperTitle = '智力残疾康复个别化教育计划（IEP）' + '-' + title + '训练表';
                        this.iepTotalTheme = verticalTitle;
                    }
                    ...
                    this.showTrianingPaperFlag = true;
            ...
            editCourseDetails() {
                ...
                this.showPlanItemContentFlag = false;
                this.showWeekContentFlag = false;
                this.showMouthContentFlag = true;
