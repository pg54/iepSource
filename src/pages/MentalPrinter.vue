<template>
    <div class="printWrap">
        <div class="print-sider onc-scrollbar">
            <h2 class="print-sider-title">广东省智障儿童康复档案</h2>
            <el-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose">
                ...
                <!--&lt;!&ndash;<el-menu-item :index="'5-'+ (el + 1)+ (index + 1)" @click="checkCPEPResult(index, item)"&ndash;&gt;-->
                <!--&lt;!&ndash;&gt;{{ item.PatientAgentName }}</el-menu-item>&ndash;&gt;-->
