<template>
    <div class="main">
        ...
        <div class="registerBox">
            <el-form ref="form" :rules="rules" :model="userInfo" label-width="128px" label-position="right" style="width:100%;">
                <!--个人信息-->
                <el-row :gutter="24">
                    <el-col :span="24">
                        <el-row>
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="性别" prop="Sex">
                                    <el-select placeholder="请选择" style="width:100%" v-model="userInfo.Sex">
                                        <el-option v-for="item in sexsArrary" :key="item.Key" :label=item.Value :value=item.Key></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :span="6">
                                <el-form-item label="出生日期" prop="BirthDate">
                                    <el-date-picker type="date" placeholder="选择日期" :picker-options="pickerOptions" v-model="userInfo.BirthDate" format="yyyy-MM-dd" style="width: 100%;"></el-date-picker>
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="用户名" prop="UserName" >
                                    <el-input v-if="userNamePrepend" v-model="userInfo.UserName" :disabled="true" placeholder="请填写用户名"></el-input>
                                    <el-input v-else placeholder="请填写用户名" v-model="userInfo.UserName">
                            ...
                            <el-col :span="6">
                                <el-form-item label="诊断科室">
                                    <el-select placeholder="请选择" style="width:100%" @change="deptOnChange" v-model="userInfo.DeptID">
                            ...
                            <el-col :span="6">
                                <el-form-item label="诊断时间">
                                    <el-date-picker type="date" placeholder="请诊断时间" style="width:100%" v-model="userInfo.DiagnosisDate"></el-date-picker>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    ...
                    <el-row :gutter="24">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="临床表现">
                                    <el-input type="textarea" autosize placeholder="请输入临床表现" v-model="userInfo.Comments"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <!--<el-date-picker type="date" placeholder="请选择" style="width:100%"-->
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="文化程度">
                                    ...
                                    <!--<el-input placeholder="请输入" v-model="userInfo.Member1.Degree"></el-input>-->
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="文化程度">
                                    ...
                                    <!--<el-input placeholder="请输入" v-model="userInfo.Member2.Degree"></el-input>-->
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="文化程度">
                                    ...
                                    <!--<el-input placeholder="请输入" v-model="userInfo.Member3.Degree"></el-input>-->
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="家庭模式">
                                    <div style="position:relative;">
                                        <!--<span style="margin-left:110px;width:20px;overflow:hidden;">-->
                                        <el-select style="width:59px;margin-left:100px;display: inline-block" :onchange="change5" v-model="userInfo.FamilyModel">
                                            <el-option v-for="(item, index) in familyModels" :key="item.Name" :label=item.Name :value=item.Name>
                                            </el-option>
                                        </el-select>
                                        <!--</span>-->
                                        <el-input name="box" v-model="userInfo.FamilyModel" style="width:130px;position:absolute;left:0px;"></el-input>
                                    </div>
                                </el-form-item>
                            </el-col>
                                ...
                                <el-form-item label="居住社区">
                                    <div style="position:relative;">
                                        <span style="margin-left:100px;width:18px;overflow:hidden;">
                                            <el-select style="width:58px;margin-left:-10px" :onchange="change4" v-model="userInfo.Community">
                                                <el-option v-for="(item, index) in communities" :key="item.Name" :label=item.Name :value=item.Name>
                                                </el-option>
                                            </el-select>
                                        </span>
                                        <el-input name="box" v-model="userInfo.Community" style="width:120px;position:absolute;left:0px;"></el-input>
                                    </div>
                                </el-form-item>
                            </el-col>
                            <el-col :span="6">
                                <el-form-item label="教养方式">
                                    <div style="position:relative;">
                                        <span style="margin-left:100px;width:18px;overflow:hidden;">
                                            <el-select style="width:58px;margin-left:-10px" :onchange="change3" v-model="userInfo.EducationStyle">
                                                <el-option v-for="(item, index) in educationStyles" :key="item.Name" :label=item.Name :value=item.Name>
                                                </el-option>
                                            </el-select>
                                        </span>
                                        <el-input name="box" v-model="userInfo.EducationStyle" style="width:120px;position:absolute;left:0px;"></el-input>
                                    </div>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :span="6">
                                <el-form-item label="抚养/带教人">
                                    <div style="position:relative;">
                                        <span style="margin-left:100px;width:18px;overflow:hidden;">
                                            <el-select style="width:58px;margin-left:-10px" :onchange="change1" v-model="userInfo.Dependents">
                                                <el-option v-for="(item, index) in dependents" :key="item.Name" :label=item.Name :value=item.Name>
                                                </el-option>
                                            </el-select>
                                        </span>
                                        <el-input name="box" v-model="userInfo.Dependents" style="width:120px;position:absolute;left:0px;"></el-input>
                                    </div>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="语言环境">
                                    <div style="position:relative;">
                                        <span style="margin-left:100px;width:18px;overflow:hidden;">
                                            <el-select style="width:58px;margin-left:-10px" :onchange="change2" v-model="userInfo.Language">
                                                <el-option v-for="(item, index) in languages" :key="item.Name" :label=item.Name :value=item.Name>
                                                </el-option>
                                            </el-select>
                                        </span>
                                        <el-input name="box" v-model="userInfo.Language" style="width:120px;position:absolute;left:0px;"></el-input>
                                    </div>
                                </el-form-item>
                        ...
                        <el-row>
                            ...
                            <el-col :span="6">
                                <el-form-item label="先兆流产">
                                    <el-select v-model="abortionStatus" placeholder="请选择">
                                        <el-option label="有" value=true></el-option>
                                        <el-option label="无" value=false></el-option>
                                    </el-select>

                                    <div v-if="abortionStatus === 'true'? true: false" style="display: inline-block">
                                        <el-select v-model="userInfo.ThreatenedAbortion" style="width:80%">
                            ...
                            <el-col :span="6">
                                <el-form-item label="足月">
                                    <el-select v-model="matureStatus" placeholder="请选择">
                                        <el-option label="是" value=false></el-option>
                                        <el-option label="否" value=true></el-option>
                                    </el-select>
                                    <div label="" v-if="matureStatus === 'true'?true:false">
                                        <el-input placeholder="请输入" v-model="userInfo.Mature" style="width:80%"></el-input>&nbsp;&nbsp;&nbsp;周
                                    </div>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="早产或过期">
                                    <el-select v-model="prematureOrExpiredText">
                                        <el-option label="早产" value='早产'></el-option>
                                        <el-option label="过期" value='过期'></el-option>
                                    </el-select>
                                    <div>
                                        <el-form-item label="">
                                            <el-input placeholder="请输入" style="width:80%" v-model="prematureOrExpiredTime"></el-input>&nbsp;&nbsp;&nbsp;周
                                        </el-form-item>
                                    </div>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :span="6">
                                <el-form-item label="分娩方式">
                                    <el-select v-model="userInfo.Parturition">
                            ...
                            <el-col :span="6">
                                <el-form-item label="窒息">
                                    <el-select v-model="userInfo.Suffocate">
                            ...
                            <el-col :span="6">
                                <el-form-item label="出生体重">
                                    <el-input placeholder="请输入" v-model="userInfo.BirthWeight" style="width:80%"></el-input>
                                    &nbsp;&nbsp;&nbsp;g
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="母乳喂养">
                                    <el-select v-model="userInfo.Breastfeeding">
                            ...
                            <el-col :span="6">
                                <el-form-item label="人工喂养">
                                    <el-select v-model="userInfo.ArtificialFeeding">
                                        <el-option label="是" value='是'></el-option>
                                        <el-option label="否" value='否'></el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="6">
                                <el-form-item label="高热抽搐">
                                    <el-select v-model="userInfo.HighFeverTwitching">
                                        <el-option label="有" value='有'></el-option>
                                        <el-option label="无" value='无'></el-option>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-col :span="6">
                                <el-form-item label="会抬头时间" class='shortLabel'>
                                    <el-input placeholder="请输入" v-model="userInfo.LookedUpTime" style="width:80%"></el-input>
                                    &nbsp;&nbsp;&nbsp;周
                                </el-form-item>
                            </el-col>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="既往病史">
                                    <el-select v-model="illnessHistoryStatus" placeholder="请选择">
                                        <el-option label="有" value=true></el-option>
                                        <el-option label="无" value=false></el-option>
                                    </el-select>

                                    <div v-if="illnessHistoryStatus === 'true'?true:false">
                                        <el-form-item label="">
                            ...
                            <el-col :span="6">
                                <el-form-item label="过敏史">
                                    <el-select v-model="allergyHistoryStatus" placeholder="请选择">
                                        <el-option label="有" value=true></el-option>
                                        <el-option label="无" value=false></el-option>
                                    </el-select>

                                    <div v-if="allergyHistoryStatus === 'true'?true:false">
                                        <el-form-item label="">
                            ...
                            <el-col :span="6">
                                <el-form-item label="特殊饮食习惯">
                                    <el-select v-model="SpecialEatingHabitsStatus" placeholder="请选择">
                                        <el-option label="有" value=true></el-option>
                                        <el-option label="无" value=false></el-option>
                                    </el-select>

                                    <div v-if="SpecialEatingHabitsStatus === 'true'?true:false">
                                        <el-form-item label="">
                            ...
                            <el-col :span="6">
                                <el-form-item label="特殊睡眠时间">
                                    <el-select v-model="SpecialSleepingTimeStatus" placeholder="请选择">
                                        <el-option label="有" value=true></el-option>
                                        <el-option label="无" value=false></el-option>
                                    </el-select>
                                    <div v-if="SpecialSleepingTimeStatus === 'true'?true:false">
                                        <el-form-item label="">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="目前主要障碍情况">
                                    <el-input type="textarea" autosize placeholder="请输入" v-model="userInfo.ObstacleState"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :span="24">
                                <el-form-item label="既往康复教育情况">
                                    <el-input type="textarea" autosize placeholder="请输入" v-model="userInfo.RecoveryHistory"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
            ...
            <div class="submitBox" v-bind:class="{narrowSubmitBox : narrow}">
                <el-button type="primary" @click="updateUserinfo()">保存</el-button>
                <el-button type="primary" @click="printPreview()">打印预览</el-button>
            </div>
        </div>

        <el-dialog title="请选择档案类型" v-model="selectPrinterVisible" :close-on-click-modal="false" :show-close="false">
            <div class="addTestFormWrap">
                <el-select v-model="printValue" placeholder="请选择要打印的档案类型" style="width: 100%">
                    <el-option v-for="item in printerOptions" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
            </div>
            <div slot="footer" class="dialog-footer">
                <el-button @click="selectPrinterVisible = false">取 消</el-button>
                <el-button type="primary" @click.native="jumpToPrinter()">确 定</el-button>
            </div>
        </el-dialog>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                abortionStatus: '', //先兆流产
                matureStatus: '', //足月
                illnessHistoryStatus: '', //有无病史
                allergyHistoryStatus: '', //有无过敏史
                SpecialEatingHabitsStatus: '', //特殊饮食
                SpecialSleepingTimeStatus: '', //特殊睡眠
                prematureOrExpiredText: '', //早产或过期 文字部分
                prematureOrExpiredTime: '', //早产或过期 周数
                ...
                printerOptions: [{
                    ...
                    value: 'hearingPrinter',
                    label: '广东省听障儿童康复档案'
                }, {
                    value: 'physicalPrinter',
                    label: '广东省肢体残疾儿童康复档案'
                }, {
                    value: 'mentalPrinter',
                    label: '广东省智障康复教育班级教学计划'
                }],
                printValue: '',
                pickerOptions: {
                    disabledDate(time) {
        ...
        methods: {
            ...
            init() {
                //获取患者详细信息
                let _this = this;
                _this.requestRefrecePerson();
                _this.requestPatientStatus();
                _this.requestOriginalOrgs();
                let patientId = _this.$store.state.mystudent.currentPatientInfo.ID;
                api.getPatientAgentDetails(patientId).then(res => {
                    // pg54
                    let o = res.data;
                    _this.saveCurrentPatientInfo(o);
                    _this.userInfo = res.data;
                    let birthData = res.data.BirthDate
                    _this.birthDayStr = birthData
                    _this.userInfo.BirthDate = new Date(birthData);
                    _this.userNamePrepend = res.data.UserName ? true : false;
                    ...
                    //早产或过期分成2个字段
                    let length = _this.userInfo.PrematureOrExpired == null ? 0 : _this.userInfo.PrematureOrExpired
                        .length;
            ...
            requestDiagnosises() {
                ...
                api.requestDept()
                    .then(res => {
                        ...
                        let n = res.data.List;
                        let d = n.filter(ele => ele.ID === _this.userInfo.DeptID)[0].Diagnosises;
                        _this.diagnosises = d;

                        // let i = _this.getDeptInfo(res.data.List, _this.userInfo.DiagnosisID)
                        // if (i === '') {
                        //     let obj = {
                        //         ID: '',
                        //         DeptName: '',
                        ...
                        //         BirthDate: _this.birthDayStr
                        //     }
                        //     _this.$store.dispatch('setCurrentPatientDept', obj);
                        // } else {
                        //     let obj = {
                        //         ID: _this.diagnosisesDept[i].ID,
                        //         DeptName: _this.diagnosisesDept[i].Name,
                        //         Name: _this.userInfo.Name,
                        //         Sex: _this.userInfo.Sex,
                        //         BirthDate: _this.birthDayStr
                        //     }
                        //     _this.$store.dispatch('setCurrentPatientInfo', obj);
            ...
            updateUserinfo() {
                this.$refs['form'].validate((valid => {
                    if (valid) {
                        let _this = this;  //这里传的是BirthDate对象，不是string
                        let params = _this.handleSpecialFields(_this.userInfo);
                        params.UserName = _this.institutionCode + params.UserName;
                        api.postPatientAgentDetails(params).then(res => {
                            if (res.data.Code === 0) {
                                _this.$message.success('保存成功！');
                                _this.init();
                                _this.refreshPatientInfo();
                            } else {
                                _this.$message.warning(res.Msg);
                            }
                        }).catch(err => {
            ...
            jumpToPrinter() {
                if (this.printValue === '') {
                    this.$message.warning('请选择打印档案类型');
                } else {
                    let path = '/' + this.printValue;
                    let pIndex = this.printerOptions.map(ele => ele.value).indexOf(this.printValue);
                    let str = this.printerOptions.map(ele => ele.label)[pIndex];
                    let pTitle = str.replace(/广东省康复档案/,'')
                    this.$store.dispatch('setPrintPaperTitle', pTitle);
                    this.$router.push({
                        path: path
                    });
                }
            },
            handleSpecialFields(userInfo) {
                if (this.abortionStatus === 'false') {
                    this.userInfo.ThreatenedAbortion = '' //先兆流产
                }
                if (this.matureStatus === 'true') { //足月
                    this.userInfo.Mature = ''
                }
                if (this.illnessHistoryStatus === 'false') { //有无病史
                    this.userInfo.IllnessHistory = ''
                }
                if (this.allergyHistoryStatus === 'false') { //过敏史
                    this.userInfo.AllergyHistory = ''
                }
                if (this.SpecialSleepingTimeStatus === 'false') { //特殊睡眠
                    this.userInfo.SpecialSleepingTime = ''
                }
                if (this.SpecialEatingHabitsStatus === 'false') { //特殊饮食
                    this.userInfo.SpecialEatingHabits = ''
                }
                this.userInfo.PrematureOrExpired = this.prematureOrExpiredText + this.prematureOrExpiredTime
            ...
            beforeAvatarUpload() {},
            changetags(currentValue) {
            },
            change1(text) {
                this.userInfo.Dependents = text;
            },
            change2(text) {
                this.userInfo.Language = text;
            },
            change3(text) {
                this.userInfo.EducationStyle = text;
            },
            change4(text) {
                this.userInfo.Community = text;
            },
            change5(text) {
                this.userInfo.FamilyModel = text;
            }
        },
        created() {
