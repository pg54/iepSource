<template>
    <div id="planpaper1">
        <div class="paperform-content">
            ...
            <div id="paperform-form2">
                <table class="tg">
                    ...
                    <template v-if="iepMothInfo.length === 0">
                        <td class="tg-s6z2" colspan="24">未安排计划</td>
                    </template>
                    <template v-else>
                        <tr>
                            <th class="tg-s6z2" colspan="2" rowspan="2">计划名</th>
                            <th class="tg-s6z2" colspan="2" rowspan="2">教学主题</th>
                            <th class="tg-s6z2" colspan="8" rowspan="2">教学计划</th>
                            <th class="tg-s6z2" colspan="8" rowspan="2">教学内容</th>
                    ...
                    <tr>
                        <td class="tg-s6z2" colspan="2"><div style="display: inline-block;height: 4rem;line-height: 4rem;">周总结</div></td>
        ...
        <!-- <el-row :gutter="20" id="teacherComment1" style="margin: 5px;border: 2px solid #118dee;border-radius: 4px;padding: 8px;box-sizing: border-box">
            <el-col :span="20">
                <el-row>
    ...
    export default {
        ...
        computed: {
            ...
            patientBirthday: function () {
                return this.$store.state.mystudent.currentPatientInfo.BirthDate ? this.$store.state.mystudent.currentPatientInfo.BirthDate.split(' ')[0] : '';
            },
        ...
        methods: {
            ...
            createdLastImg() {
                let _this = this;
                let p = document.querySelector("#planpaper1");
                let c = document.querySelector(".paperform-content") 
                let t = document.querySelector("#teacherComment1")
