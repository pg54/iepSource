<template>
    <div class="nav">
        ...
        <ul class="navbar">
            ...
            <li v-if="fullFuction">
                <router-link class='link' to="/dynamicConsultation">
            ...
            <!-- <li>
                <router-link class='link' to="/serviceReview">
                    <div class="itemImg authLink"></div>
                    <p class="itemText">服务审核</p>
                    <div class="triangle-up">
                        <img src="../assets/images/多边形-1.png" alt="">
                    </div>
                </router-link>
        ...
        <div class="person">
            <el-row>
                <!-- <el-col :span="6">
                    <Icon type="arrow-expand" size="32" color="#001a5d" class="fullScreenBtn" @click.native="handleFullScreen"></Icon>
                </el-col> -->
                ...
                <el-col :span="16" class="userinfo">
                    <el-dropdown trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item @click.native="toMyMsg">我的消息</el-dropdown-item>
        ...
        <!-- <div class="changeSize">
            <img src="../assets/images/size/min.png" alt="" @click="cancelFullScreen">
            <img src="../assets/images/size/max.png" alt="" @click="handleFullScreen">
            <img src="../assets/images/size/close.png" alt="" >
        </div> -->
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            fullFuction: function () {
                return localStorage.getItem('isfullFuction')? true: false;
            }
        },
        data() {
            return {
