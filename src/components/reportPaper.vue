        ...
        <div class="tabs">
            ...
            <div class="tabs-content">
                                        ...
                                        <el-row>
                                            <el-col :span="5">
                                                <el-form-item label="家庭模式:">
                                                    <el-input placeholder=""
                                                              v-model="userInfo.FamilyModel" :disabled="true"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :span="5">
                                                <el-form-item label="居住社区:">
                                                    <el-input placeholder=""
                                                              v-model="userInfo.Community" :disabled="true"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :span="5">
                                                <el-form-item label="教养方式:">
                                                    <el-input placeholder=""
                                                              v-model="userInfo.EducationStyle" :disabled="true"></el-input>
                                                </el-form-item>
                                            </el-col>
                                            ...
                                            <el-col :span="5">
                                                <el-form-item label="抚养/带教人:">
                                                    <el-input placeholder=""
                                                              v-model="userInfo.Dependents" :disabled="true"></el-input>
                                                </el-form-item>
                                            </el-col>
                                        </el-row>
                                        ...
                                        <el-row>
                                            <el-col :span="5">
                                                <el-form-item label="语言环境:">
                                                    <el-input placeholder="" v-model="userInfo.Language" :disabled="true"></el-input>
                                                </el-form-item>
                                            </el-col>
                                        </el-row>
                                    </el-col>
                ...
                <div v-show="currentTab === 3" class="tab-content">
                    ...
                    <el-dialog title="" v-model="modifySummaryVisible" :modal-append-to-body="false">
...
//                this.newVisible = true
                this.summaryText = this.rourseData.Summary;
            },
            updateSummary() {
                let params = {
