...
//    import base64 from '../util/base64'
    ...
    export default {
        ...
        data() {
            return {
                ...
                // baseURL: '//api.account.onenewcare.com',
                /* global baseLoginlURL:true */
                baseUrl: '//devapi.account.onenewcare.com',
            //    baseUrl: '//192.168.0.173/OPEM.API.Account',
            };
        },
    ...
    setCookie(name, value) {
            ...
            tofour() {
                localStorage.removeItem('isfullFuction');
                var _this = this;
                setTimeout(function () {
            ...
            stillEight() {
                localStorage.setItem('isfullFuction', 'fullFuction');
                var _this = this;
                setTimeout(function () {
                    _this.chosedFunction = true;
                }, 500)
