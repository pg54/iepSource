<template>
    <div class="main" v-loading.fullscreen.lock="articleLoading">
                ...
                <div v-show="currentTab === 0" class="tab-content">
                    <div class="center-content" style="padding-left:20px">
                        ...
                        <div class="toolBox clearfix">
                            <el-button @click="goAddTrainingForm" style="float:right;margin-right: 80px">
...
export default {
    ...
    methods: {
        ...
        shortTitle(originStr) {
            if (originStr.length > 20) {
                let newStr = originStr.substr(0, 17) + '...';
                return newStr;
            } else {
                return originStr;
            }
