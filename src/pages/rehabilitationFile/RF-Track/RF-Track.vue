                            ...
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" class="content">
                                    <el-form-item label="毕业时间:">
                                        <el-date-picker type="date" placeholder="选择日期" :picker-options="pickerOptions0" v-model="trackDetails.GraduationDate" style="width:100%"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" class="content">
                                    <el-form-item label="转介幼儿园时间:">
                                        <el-date-picker type="date" placeholder="选择日期" :picker-options="pickerOptions0" v-model="trackDetails.ReferralKindergartenDate" style="width:100%"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" class="content">
                                    <el-form-item label="转介特殊学校时间:">
                                        <el-date-picker type="date" placeholder="选择日期" :picker-options="pickerOptions0" v-model="trackDetails.ReferralSpecialSchoolDate" style="width:100%"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" class="content">
                                    <el-form-item label="转介普通小学时间:">
                                        <el-date-picker type="date" placeholder="选择日期" :picker-options="pickerOptions0" v-model="trackDetails.ReferralPrimarySchoolDate" style="width:100%"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            ...
                            <el-row :gutter="24">
                                ...
                                <el-col :span="12" class="content">
                                    <el-form-item label="访问方式:">
                                        <el-select v-model="trackDetails.VisitType" placeholder="请选择" style="width:100%">
                                            <el-option v-for="(item, index) in visitTypes" :key="item.ID" :label=item.Name :value=item.ID>
                                            </el-option>
                                        </el-select>
                                    </el-form-item>
                                </el-col>
...
export default {
    ...
    methods: {
        ...
        saveTrack() {
            ...
            if (_this.studentId === "") {
                _this.studentId = _this.$store.state.mystudent.currentPatientInfo;
            }
    ...
    created() {
        this.studentId = this.$store.state.mystudent.currentPatientInfo.ID;
        this.requestTracks();
    }
};
</script>
