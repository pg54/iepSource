<template>
    <div class="paperform-content">
        ...
        <div id="paperform-form2" v-if="userInfo">
            <table class="tg">
                    ...
                    <template v-for='course in userInfo.Courses'>
                        <tr>
                            ...
                            <td class="tg-textleft" colspan="20">
                                ...
                                <div class='themeCharacteristic clearfix'>
        ...
        <div v-else>
            <p style="text-align: center;height: 100px;line-height: 100px;font-size: 22px;border: 1px solid #495060">入学评测未完成</p>
        </div>
    </div>
</template>
