...
vAjax.interceptors.response.use(function (response) {
    return response;
  }, function (error) {
...
// let base = '//api.app.onenewcare.com';
/* global baseNormalURL:true */
let base = '//devapi.app.onenewcare.com';
// let base = '//192.168.0.173/OPEM.API.App';

// 4-1 医生的病人列表,已分组
export const getDoctorPatientList = params => { return vAjax.get(`${base}/Dr/PatientAgent/List`, { params: params }).then(res => res.data); };
...
//单个服务的内容
export const getDrServiceDetail = (serviceID) => { return vAjax.get(`${base}/Service/Details/${serviceID}`); };
...
export const getIEPCourses = params => { return vAjax.get(`${base}/Dr/Course/List`, { params: params }); };
...
//获取孤独症三个表
export const getGuduPapers = params => { return vAjax.get(`${base}/Dr/CPEP/PaperList`,  { params: params }) };

// CPEP http://devapi.app.onenewcare.com/CPEP/Questions
export const getCPEP = params => { return vAjax.get(`${base}/CPEP/Questions`,  { params: params }) };

// CPEP http://devapi.app.onenewcare.com/CPEP/Member
export const getCPEPMember = params => { return vAjax.get(`${base}/CPEP/Members`,{ params: params }) };

// CPEP http://devapi.app.onenewcare.com/CPEP/Result
export const postCPEPResult = params => { return vAjax.post(`${base}/CPEP/Result`, params) };

//删除cpep
export const deleteCPEP = params => { return vAjax.post(`${base}/CPEP/Remove`, params) };

//
export const getCPEPReport = params => { return vAjax.get(`${base}/CPEP/Report`, { params: params }) };

//http://devapi.app.onenewcare.com/Dr/PaperPackage/Entrance
export const getEntrancePackage = params => { return vAjax.get(`${base}/Dr/PaperPackage/Entrance`, { params: params }) };

//患者的推荐人
export const getReferecePersons = params => { return vAjax.get(`${base}/Setting/List/REFEREETYPE`).then(res => res.data); };

//患者状态
export const getPatientStatus = params => { return vAjax.get(`${base}/Setting/List/STUDENTSTATUS`).then(res => res.data); };

//原始机构
export const getOriginalOrgs = params => { return vAjax.get(`${base}/Dr/PatientAgent/OriginalOrgs`).then(res => res.data); };

//Dr/PatientAgent/Referees?typeId=&key=
export const getRefrences = params => { return vAjax.get(`${base}/Dr/PatientAgent/Referees`, { params: params }).then(res => res.data); };
